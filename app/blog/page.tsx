        ...
        <div className="space-y-4">
          {posts.map((post) => (
            <a
              ...
              className="flex items-start justify-between gap-4 glass rounded-2xl p-6 group hover:border-[#F97316]/20 transition-all duration-300"
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-1.5 mb-3">
                  ...
                  >
                    {post.source === "linkedin" ? "LinkedIn" : "Medium"}
                  </span>
                </div>
